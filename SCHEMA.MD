...
| `mode` | `String` | Not Null, Default: `'upsert'` | Ingestion mode: strictly `'upsert'` |
...
| `mode` | `String` | Not Null, Default: `'upsert'` | Sync mode: strictly `'upsert'` |
...
| `api_key_name` | `String` | Nullable | Denormalized actor name |
| `api_key_prefix` | `String` | Nullable | Denormalized actor key prefix |
| `client_ip` | `String` | Nullable | Resolved client IP |
